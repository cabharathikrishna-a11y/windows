...
// Compose Multiplatform Desktop Packaging Configuration
// Used when building native Windows executables (.exe, .msi) via jpackage / Gradle Desktop tasks
/*
compose.desktop {
    application {
        ...
        nativeDistributions {
            ...
            description = "An all-in-one Productivity & Life OS"
            copyright = "© 2026 Life OS. All rights reserved."
        }
    }
}
*/
